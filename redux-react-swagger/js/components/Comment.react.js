...
var Comment = React.createClass({
    ...
    render: function() {
        ...
        return (
            <li className="comment">
                <p>
                    <strong className="text-primary">{this.props.comment.authorName}: </strong>
    ...
    _onPost: function() {
        ...
        AppActions.createComment({
            ...
            parentMoment: this.props.comment.parentMoment,
            text: this.refs.newCommentTextInput.value
        });
